...
int main(int argc, char *argv[]) {
    ...
    viewer.setMainQmlFile(QLatin1String("qml/FolderGallery/Main_maemo_5.qml"));
    viewer.showFullScreen();
#elif defined(Q_WS_HARMATTAN)
    viewer.setOrientation(QmlApplicationViewer::ScreenOrientationAuto);
    viewer.setMainQmlFile(QLatin1String("qml/FolderGallery/Main_harmattan.qml"));
    viewer.showFullScreen();
#elif defined(Q_OS_SYMBIAN)
    viewer.setOrientation(QmlApplicationViewer::ScreenOrientationAuto);
    viewer.setMainQmlFile(QLatin1String("qml/FolderGallery/Main_symbian.qml"));
    viewer.showFullScreen();
#else
//    (defined(Q_WS_WIN) || defined(Q_WS_X11))
    viewer.setMainQmlFile(QLatin1String("qml/FolderGallery/Main_desktop.qml"));
    viewer.show();
#endif
//    viewer.showExpanded();
    return app.exec();
